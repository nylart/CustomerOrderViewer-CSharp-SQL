...
namespace CustomerOrderViewer.Models.Repository
{
        ...
        public IList<CustomerOrderDetailModel> GetList()
        {
            ...
            using (SqlConnection connection = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd =
                    new SqlCommand(
                        "SELECT CustomerOrderId, CustomerId, ItemId, FirstName, LastName, [Description], Price FROM CustomerOrderDetail", connection))
                {
